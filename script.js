...
// ===== データ取得と初期設定 =====
fetch("https://script.google.com/macros/s/AKfycbzJhjxprctTYgA2HU-czuVEtzOxSob0Ved37j_OFm_lA81IZuwLEsw6In2ryr7LissW/exec") // ※ご自身のGASのURLに書き換えてください
...
async function saveData() {
    ...
    try {
        const response = await fetch("https://script.google.com/macros/s/AKfycbzJhjxprctTYgA2HU-czuVEtzOxSob0Ved37j_OFm_lA81IZuwLEsw6In2ryr7LissW/exec", {
            method: 'POST',
