...
// ===== データ取得と初期設定 =====
fetch("https://script.google.com/macros/s/AKfycbw1b4qmm0L085DEkabXVbIT2H7NK9uKHrUSaq1SyLj-dl86XTQSpjBlPhJ4oRM5a-CB/exec") // ※ご自身のGASのURLに書き換えてください
...
async function saveData() {
    ...
    try {
        const response = await fetch("https://script.google.com/macros/s/AKfycbw1b4qmm0L085DEkabXVbIT2H7NK9uKHrUSaq1SyLj-dl86XTQSpjBlPhJ4oRM5a-CB/exec", {
            method: 'POST',
